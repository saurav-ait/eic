...
<main class="main-content">
    ...
    <div class="top-bar">
        ...
        <button class="btn-primary" onclick="openModal()">+ Add Agent</button>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="muted small">{{ $agent->created_at->diffForHumans() }}</div>
                    </td>
...
<div id="agentModal" class="modal">
    <div class="modal-content">
        ...
        <form id="agentForm" method="POST" onsubmit="return validateForm()">
            @csrf
            <input type="hidden" id="methodField" name="_method">

            <input type="text" name="name" id="name" placeholder="Agent Name" required maxlength="255">
...
function openModal() {
    ...
    document.getElementById('agentForm').action = "{{ route('agent.store') }}";
    document.getElementById('methodField').value = '';
    document.getElementById('modalTitle').innerText = "Add Agent";
...
function editAgent(id, name, phone, email, address, status) {
    openModal();

    document.getElementById('modalTitle').innerText = "Edit Agent";
    document.getElementById('agentForm').action = "{{ route('agent.store') }}/" + id;
